...
buttons.yellow.addEventListener('click', () => {
    applyTheme('#E5BA41', buttons.yellow)
})

buttons.orange.addEventListener('click', () => {
    applyTheme('#F16D14', buttons.orange)
})

buttons.green.addEventListener('click', () => {
    applyTheme('#F57799', buttons.green)
})

buttons.random.addEventListener('click', () => {
    const color = generateColor();
    applyTheme(color, buttons.random)
})